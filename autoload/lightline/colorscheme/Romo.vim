" =============================================================================
" Filename: autoload/lightline/colorscheme/Romo.vim
" Author: hromojaro
" License: MIT License
" Last Change: 2017/12/25 18:40:20.
" =============================================================================
...
let s:p.insert.left = [ [ s:background, s:green ], [ s:statusline_active_fg, s:status ], [ s:statusline_active_fg, s:statusline_active_bg ] ]
...
let s:p.tabline.middle = [ [s:tabline_inactive_fg, s:tabline_bg]]
let s:p.tabline.right = copy(s:p.normal.right)
let s:p.normal.error = [ [ s:background, s:error ] ]
let s:p.normal.warning = [ [ s:background, s:olive ] ]

let g:lightline#colorscheme#Romo#palette = lightline#colorscheme#fill(s:p)
